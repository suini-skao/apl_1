...
verifh("./");
$reqm=$base->prepare('SELECT* FROM maison WHERE idp=:iden');
$reqm->execute(array("iden"=>$id));
?>
<!DOCTYPE html>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="edit--profile-area">
                            <ul class="edit--profile-links list-unstyled mb-0">
                                <li><a href="user-profile.php">Mon Profile</a></li>
                                <li><a href="social-profile.php">Profile Social</a></li>
                                <li><a href="my-properties.php" class="active">Mes Propertés</a></li>
                                <li><a href="favourite-properties.php">Propertés Favories</a></li>
                                <li><a href="add-property.php">Ajout Propriété</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- .col-md-4 -->
                    <div class="col-xs-12 col-sm-8 col-md-8">
                        <!-- .property-item #1 -->
                        <?php while($info=$reqm->fetch()) { $ok="aut"; ?>
                        ...
                        <span class="property--status"><?php echo $info['statu'];?></span>
                            ...
                            <div class="property--content">
                                ...
                                <div class="property--features">
                                    ...
                                    <a href="#" class="edit--btn"><i class="fa fa-edit"></i>Editer</a>
                                    <a value="<?php echo $info['idmaison'];?>" class="edit--btn supa"  id="<?php echo "d".$info['idmaison'];?>" onclick="supr(this)" style="cursor:pointer"><i class="fa fa-edit"></i>Supprimer</a>
                                </div>
