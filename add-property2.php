                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                <div class="title--heading">
                                    <h1 style="color:orange">Ajout Propriété Phase 2</h1>
                                </div>
                                <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <form class="mb-0" id="sender" enctype="multipart/form-data">
                            ...
                            <!-- .form-box end -->
                            <input type="hidden" value="<?php echo  $_SESSION['idmaison_eng']; ?>" name="idmais"  id="idmais">
...
============================================= -->
    ...
    <script> 
    Addregroup2("#sender","#sender1");
    $("#prop").click(function(){
      
      let lient="add-property2.php";
