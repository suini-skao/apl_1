                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                <div class="title--heading">
                                    <h1 style="color:orange">Ajout Propriété</h1>
                                </div>
                                <ol class="breadcrumb">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <form class="mb-0" id="sender" enctype="multipart/form-data">
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title" >Description Propriété</h4>
                                        <input type="hidden" name="idp" idp="idp" value="<?php echo $_SESSION['idprop'];?>">
                                    </div>
                                    <!-- .col-md-12 end -->
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label for="property-title">Titre de Propriété</label>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label for="property-description">Description Propriété*</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Bathrooms">Douches</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Sale-Rent-Price">Prix de vente ou de location*</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Before-Price-Label">Prix de départ</label>
                                            <input type="text" class="form-control" name="Before-Price-Label" id="Before-Price-Label" placeholder="ex: debut">
                                        </div>
                                    </div>
                                    <!-- .col-md-4 end -->
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="After-Price-Label">Prix après réduction</label>
                                            <input type="text" class="form-control" name="After-Price-Label" id="After-Price-Label" placeholder="ex: Mensuel">
                                        </div>
                                    </div>
                                    <!-- .col-md-4 end -->
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="Property-ID">N° CNI*</label>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4" >
                                        <div class="form-group" >
                                            <label for="eh">Video de la maison</label>
                                            <a class="btn btn--primary btn-file ml-30"  name="eh" >Selection
                                            <input type="file" id="videosp" hidden>
                                            </a>
                                        </div>
                                    </div>  -->
                                    <!-- .col-md-4 end -->
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title">Composant de la Properté</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="input-checkbox">
                                            <label class="label-checkbox">
                                        <span>Balcon</span>
                                        <input type="checkbox" name="balcon" id="bal">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <input type="checkbox" name="animaux" id="pa2">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="input-checkbox">
                                            <label class="label-checkbox">
                                        <span>Barbeque</span>
                                        <input type="checkbox" name="barbeque" id="pa3">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <input type="checkbox" name="alarm" id="pa4">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <input type="checkbox" name="cuisine" id="pa5">
                                        <span class="check-indicator" id="mc"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="input-checkbox">
                                            <label class="label-checkbox">
                                        <span>Sauna</span>
                                        <input type="checkbox" name="sauna" id="pa6">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <div class="input-checkbox">
                                            <label class="label-checkbox">
                                        <span>Gym</span>
                                        <input type="checkbox" name="gym" id="pa7">
                                        <span class="check-indicator"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <span class="check-indicator" id="acs"></span>
                                    </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        ...
                                        <span class="check-indicator" id="pa9"></span>
                                    </label>
                                        </div>
                                    </div>
                                    <!-- .col-md-3 end -->
                            ...
                            <div class="form-box">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <h4 class="form--title">Lieu de Propriété</h4>
                                    </div>
                                    <!-- .col-md-12 end -->
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="address">Address*</label>
                                            <input type="text" class="form-control" name="address" id="address" placeholder="Entrer le lieu de la propriété" required>
                                        </div>
                                    </div>
                                    <!-- .col-md-4 end -->
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="select-status">Ville</label>
                                            <div class="select--box">
                                                <i class="fa fa-angle-down"></i>
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            <label for="neighborhood">Voisins</label>
