                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn--primary btn-file ml-30" name="cb" >Selection
                                            <input type="file" id="imagesp" multiple hidden>
                                            </a>
                                        </div>
                                    </div>
                                    <!-- .col-md-4 end 
