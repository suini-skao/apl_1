                        ...
                        <ul class="nav navbar-nav nav-pos-center navbar-left">
                            ...
                            <li class="has-dropdown">
                                ...
                                <li><a href="user-profile.php">Mon profile</a></li>
                                    ...
                                    <li><a href="favourite-properties.php">Propriétés Favories</a></li>
                        ...
                        <div class="title title-1 text-center">
                            <div class="title--content">
                                <div class="title--heading">
                                    <h1>Propriétés Favories</h1>
                                </div>
                                <ol class="breadcrumb">
                                    <li><a href="#">Acceuil</a></li>
                                    <li class="active">Propriétés Favories</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-4">
                        ...
                        <ul class="edit--profile-links list-unstyled mb-0">
                                <li><a href="user-profile.php" >Modifier Profile</a></li>
                                <li><a href="social-profile.php">Profil social</a></li>
                                <li><a href="my-properties.php">Mes Propriété</a></li>
                                <li><a href="favourite-properties.php" class="active">Propriétés Favories </a></li>
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <!-- .property-item #1 -->
                        <?php 
                        $reqf=$base->prepare('SELECT* FROM favorie WHERE idp=:prop');
                        $reqf->execute(array("prop"=>$id));
                    while($rech=$reqf->fetch()) { $ok="aut";
                        $reqt=$base->prepare('SELECT* FROM maison WHERE idmaison=:mais');
                        $reqt->execute(array("mais"=>$rech['idmaison']));
                        if($info=$reqt->fetch()) { ?>
                            ...
                            <div class="property--content">
                                ...
                                <div class="property--features">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><span class="feature">Surfaces:</span><span class="feature-num"><?php echo $info['surface'];?> m2</span></li>
                                        <li class="pull-right"><a class="edit--btn" style="cursor:pointer" id="<?php echo $info['idmaison'];?>" value="<?php echo $id;?>" onclick="brise(this)"><i class="fa fa-times"></i>Retirer</a></li>
                                    </ul>
                                </div>
